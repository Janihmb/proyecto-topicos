...
Route::get('projects/users', [ProjectsController::class, 'index']);
Route::get('projects/user/{userId}', [ProjectsController::class, 'indexByUser']);
Route::post('project/delete/{id}', [ProjectsController::class, 'destroy']);
Route::post('project/switch-active/{id}', [ProjectsController::class, 'switchActiveProject']);
